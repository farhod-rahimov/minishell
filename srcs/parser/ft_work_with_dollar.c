...
/*   Updated: 2021/03/26 17:30:13 by btammara         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_work_with_dollar(t_args **current_t_arg, \
							int i, t_struct *strct)
{
	...
	ft_copy_str_to_structure_t_args(strct, current_t_arg, two_char, strct->n_i);
	free(two_char);
